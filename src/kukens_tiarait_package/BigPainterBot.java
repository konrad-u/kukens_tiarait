...
public class BigPainterBot extends AbstractBot{
    ...
    public BoardField[] getcornerPoints(GameBoard gameBoard){
        ...
        cornerPoints[0] = gameBoard.getBoardField(8,8);
        cornerPoints[1] = gameBoard.getBoardField(8,24);
        cornerPoints[3] = gameBoard.getBoardField(24,24);
        cornerPoints[2] = gameBoard.getBoardField(24,8);
